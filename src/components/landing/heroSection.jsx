...
export default function HeroSection() {
  return (
    <section id="home" className="relative w-full min-h-[calc(100vh-80px)] flex flex-col items-center justify-center gap-2 overflow-hidden bg-offwhite">
      ...
      <div className="relative w-full flex flex-col items-center justify-end z-0 pointer-events-none select-none overflow-hidden">
        <motion.img
          src="/images/heroSection/cards.svg"
          alt="Hero Cards Ring"
          className="w-[200%] md:w-full h-auto object-cover origin-bottom translate-y-[35%]"
          animate={{ rotate: [-15, 15, -15] }}
          transition={{ duration: 15, repeat: Infinity, ease: "anticipate" }}
